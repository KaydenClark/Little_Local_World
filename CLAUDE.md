...
shared `AGENTS.md`. Keep shared project rules in `AGENTS.md` so Codex, Claude, and
other agents follow the same source of truth.

## Claude-Specific Notes

- `.claude/settings.json` mechanically enforces the edit scope described in prose
  in `AGENTS.md`. If you change the edit scope in one, change it in both.
