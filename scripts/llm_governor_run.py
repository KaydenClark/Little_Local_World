...
def main(argv: list[str] | None = None) -> None:
    ...
    print(f"LLM client: enabled={client.enabled} model={client.model or '(none)'} base_url={client.base_url}")
    ...
    print(f"HEALTH: {health.run_color(summary).upper()}" + ("" if not problems else " -> " + "; ".join(problems)))
